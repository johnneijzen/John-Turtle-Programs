...
Changelog
  ...
  0.08 - Adding Red stone Starting and change error to Error since lua has error as function.
--]]
...
local processRaw = 0
local process = 0
local starting = 0 -- if 0 normal if 1 then redstone starting.
local on = 0 
